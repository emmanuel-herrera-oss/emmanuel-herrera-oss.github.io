...
<Layout pageTitle="Mandelbrot Fractal using WebGL">
<div class="blog-post">
...
4. Set the color of pixel (x, y) based on the number of iterations
   ...
   - Else set the pixel to rgb(sqrt(10 _iterations), sqrt(10_ iterations), sqrt(10 \* iterations))
...
2. Setup WebGL variables that we can use to communicate between the host JavaScript application and the
   shader function. - Canvas Resolution - Center Coordinate - Zoom
