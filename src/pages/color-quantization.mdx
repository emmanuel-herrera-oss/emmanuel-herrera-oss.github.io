...
<Layout pageTitle="Color Quantization using K-Means Clustering">
<div class="blog-post">
...
k-means clustering takes a set of vectors and tries to project them onto _k_ representative vectors. There are some
...
1. Randomly pick _k_ pixels from the image. These are our initial centroids
