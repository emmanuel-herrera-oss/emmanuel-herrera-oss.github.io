---
export pageTitle: "Real-time FM Demodulator for an SDR device"
export description: "Real-time FM Demodulator for an SDR device"
pubDate: 2025-08-11
---
...
<Layout pageTitle="Real-time FM Demodulator for an SDR Device">
<div class="blog-post">
# Introduction
...
<div class="image-strip-figure" style="width: 480px;">
  ...
  <span class="image-strip-caption">
...
<video width="270" height="480" controls>
    <source src="/real-time-dsp/demo_scaled.webm" type="video/webm"/>
</video>
</div>
</Layout>
